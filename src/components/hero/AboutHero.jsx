              ...
              <div className="hero__about-content">
                ...
                <div className="hero__about-info">
                  ...
                  <div className="hero__about-text title-anim">
                    <p>
                      {
                        "Orientujeme se v moderním světě, kde se design a technologie spojují k vytvoření nezapomenutelných projektů. Naše cesta začala v roce 2013 a od té doby tvoříme s vášní v srdci a technologií v rukou."
                      }
                    </p>
                  </div>
